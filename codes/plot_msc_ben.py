...
def plot_msc(key, scaled=True) :
    ...
    if scaled:
        p1 = '/mnt/cephadrius/udel_research/msc/data/binned/scaled/v19/'
        p2 = '_coho1hr_merged_mag_plasma_'
        p3 = '_v07_80_binned_scaled_80_binned_v19.hf'
    else:
        p1 = '/mnt/cephadrius/udel_research/msc/data/binned/unscaled/v19/'
        p2 = '_coho1hr_merged_mag_plasma_'
        p3 = '_v07_80_binned_v19.hf'

    sc_fl = [p1 + 'psp'         + p2 + '20180101_20211001' + p3,
    ...
    p = '/mnt/cephadrius/udel_research/msc/data/all_data/v19/all_spacecraft_data_binned_'

    if (scaled) :
        dat = h5py.File(p + 'scaled_80_binned_v19.hf', 'r')
    else :
        dat = h5py.File(p + '80_binned_v19.hf', 'r')
