...
data_dir = f"/mnt/cephadrius/udel_research/msc/{msc}/data/validsum/"
...
fnames = [f"{data_dir}new_horizons_swap_validsum_20081010210700_v1.0.7.cdf"]
if len(fnames) == 0:
    print(
...
for fname in fnames[:]:
    ...
    count += 1
    print("Data saved for %s" % (file_name))
    print(count)
