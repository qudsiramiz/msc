...
data_dir =  '/scratch/maruca_cdaweb/' + msc + '/merged/coho1hr_magplasma'

# Location where the processed data is to be saved

save_dir = '/home/ahmadr/SpacePlasFest/msc/ulysses/data/processed/v01/'
...
BT: CDF_REAL4 [720]
Epoch: CDF_EPOCH [720]
alphaDensity: CDF_REAL4 [720]
azimuthAngle: CDF_REAL4 [720]
elevAngle: CDF_REAL4 [720]
heliocentricDistance: CDF_REAL4 [720]
heliographicLatitude: CDF_REAL4 [720]
heliographicLongitude: CDF_REAL4 [720]
numVectorsMagFldAvg: CDF_INT4 [720]
plasmaFlowSpeed: CDF_REAL4 [720]
protonDensity: CDF_REAL4 [720]
protonFlux1_HET: CDF_REAL4 [720]
protonFlux1_LET: CDF_REAL4 [720]
protonFlux2_HET: CDF_REAL4 [720]
protonFlux2_LET: CDF_REAL4 [720]
protonFlux3_LET: CDF_REAL4 [720]
protonFlux4_LET: CDF_REAL4 [720]
protonFlux5_LET: CDF_REAL4 [720]
protonTempLarge: CDF_REAL4 [720]
protonTempSmall: CDF_REAL4 [720]
>)
'''
...
for f in fnames[0:] :
    ...
    d['TpL'] = dat['protonTempLarge']
    d['TpS'] = dat['protonTempSmall']

    d['na'] = dat['alphaDensity']
    ...
    # This step takes the average value of two proton temperatures. For more
    # information please visit:	https://spdf.gsfc.nasa.gov/pub/data/ulysses
    # /plasma/swoops/ion/swoops_ion_users_guide_update_20030214.txt

    df['Tp'] = df[['TpL', 'TpS']].mean(axis=1)
...
fn = fnames[0][-45:-8] + '_' + fnames[-1][-16:-8] + '_v01.hf'
