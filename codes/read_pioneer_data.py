...
data_dir =  '/scratch/maruca_cdaweb/pioneer/' + msc

# Location where the processed data is to be saved

save_dir = '/home/ahmadr/SpacePlasFest/msc/pioneer/data/processed/v01/'
...
protonFlux1_CRT: CDF_REAL4 [744]
protonFlux2_CRT: CDF_REAL4 [744]
protonFlux3_CRT: CDF_REAL4 [744]
...
fn = fnames[0][-52:-8] + '_' + fnames[-1][-16:-8] + '_v01.hf'
