...
def plot_indiv( key=None, fl=None, ylim=None, yscale=None, ylabel=None, keycorner=1 ) :
    ...
    p1 = '../data/binned/unscaled/v13/'
    p2 = '_coho1hr_merged_mag_plasma_'
    p3 = '_v04_76_binned_v13.hf'

    sc_fl = [ p1 + 'parker'       + p2 + '20180101_20200101' + p3,
              ...
              p1 + 'voyager1'     + p2 + '19770101_20041215' + p3,
              p1 + 'voyager2'     + p2 + '19770101_20070830' + p3,
    ...
    for sc in range( n_sc ) :
        ...
        tk = where( ( isfinite( dat_r ) ) & ( isfinite( dat_k ) ) &
                    ( isfinite( dat_n ) )                           )[0]
    ...
    fname = '../figures/temp/indiv_' + fl + '_v13.pdf'
