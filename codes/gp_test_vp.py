...
axs[0, 1].set_ylabel(r"$y$ (AU)", fontsize=10)
axs[0, 1].set_title(r"$\sigma$", fontsize=10)
# Set both axes to log scale.
...
axs[1, 0].set_ylabel(r"$y$ (AU)", fontsize=10)
axs[1, 0].set_title(r"$\sigma$", fontsize=10)
# Set both axes to log scale.
...
# Don't show the axes of the last subplot.
axs[1, 1].axis("off")
